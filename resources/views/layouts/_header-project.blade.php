<nav class="navbar navbar-expand-lg navbar-light bg-white" role="navigation">
    ...
    <div class="container">
        ...
        <a class="navbar-brand" href="{{ route('project.home') }}">ODIN</a>
        ...
        <div class="collapse navbar-collapse mt-3 mt-md-0" id="navbar-collapse">
            <ul class="navbar-nav align-items-lg-center justify-content-end w-100">
                <li class="nav-item">
                    <a href="{{ route('project.terminals.index') }}" class="nav-link">
                        Terminals
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item w-25 ms-lg-4 d-lg-flex d-sm-none justify-content-end">
